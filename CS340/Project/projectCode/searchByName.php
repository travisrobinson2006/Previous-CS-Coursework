...
<div>
	...
	<table>
		...
		<?php
		//SELECT for character name, archetype, origin story and story based on user input character name
		//if no user input last name provided, search for all characters using that first name
		...
		//else search for first name/last name pair
